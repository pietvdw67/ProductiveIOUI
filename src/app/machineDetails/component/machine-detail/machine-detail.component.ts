...
export class MachineDetailComponent implements OnInit {
  ...
  onEditClick(){
    ...
    machineDetail.note = this.editNote;
    ...
    if (this.editId){
      for (let i = 0 ; i < this.dataViewServiceService.machineDetailsGet().length;i++){
        if (this.dataViewServiceService.machineDetailsGet()[i].id == parseInt(this.editId)){
          ...
          if (this.dataViewServiceService.machineDetailsGet()[i].note){
            this.editNote = String(this.dataViewServiceService.machineDetailsGet()[i].note);
          } else {
            this.editNote = '';
          }
